...
public:
   ...
   size_t position; //samples
   
   float value;
   
   bool selected;
   
   bool operator <(const CEnvelopePoint &other) const{ 
...
public:
 ...
 //calculates positions:
  ...
  int get_cursor_position(); //in sections
  int get_selection_start(); //in sections
  int get_selection_end();  //in sections
